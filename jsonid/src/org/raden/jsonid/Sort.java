...
public class Sort {
	...
	public <T> void sort(Larik<T> a) {
		if (comparableTimSort == null)
			comparableTimSort = new ComparableTimSort();
		comparableTimSort.doSort((Object[]) a.materi, 0, a.ukuran());
	}
	...
	public <T> void sort(Larik<T> a, Comparator<? super T> c) {
		if (timSort == null)
			timSort = new TimSort();
		timSort.doSort((Object[]) a.materi, (Comparator) c, 0, a.ukuran());
	}
